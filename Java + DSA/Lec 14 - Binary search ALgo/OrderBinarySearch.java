...
public class OrderBinarySearch {
    public static void main(String[] args) {
        ...
        System.out.println(" *1* Binary Search | Ascending Array: " + ((res != -1) ? "** Found at index " + res : "** Not Found!!"));
        
        // For Descending Array.
        res = SearchBinary(key, arrayDescending);
        System.out.println(" *2* Binary Search | Descending Array: " + ((res != -1) ? "** Found at index " + res : "** Not Found!!"));
    }
